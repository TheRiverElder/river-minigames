...
对于玩家在游戏中嗦扮演的角色，似乎要有一个准确的定位。之前既是底层工程师，又是顶层总裁，这样是不对的，应该定位为总裁或者工程师二选其一。

- 定位为总裁：
  - 安排任务即可，类似卡牌游戏
- 定位为中层领导：
  - 策划每个殖民地的投入占比，计算收入，调整权重
- 定位为底层工程师：
  - 设计产线，研发科技，提高生产力
...
在自然资源板块，有不同的区域，每个区域的矿产不尽相同，可以着重开发其中的部分

殖民地板资源块分为：

- 社区：用来维持人口的设施，包含了人口资源以及生产与需要消耗的维生资源（维生资源：电力、食物、生活必需品等一系列的简化资源）
- 仓储：不用多说，就是仓库
- 能源：存储电力资源的地方
- 运营：先不管
- 生产：生产资源的分配与调整的数据都在这里保存，目前先不考虑
- 科研：当前的科技成果都保存在里面，严格来说不算资源，但是算广义上的资源，目前先只考虑全局的
