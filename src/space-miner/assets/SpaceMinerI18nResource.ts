const Res = {
    ...
    "level.guide_01.title": "新手教程：{goal_name}",
    ...
    "level.guide_01.description.4": "来到星球信息栏，点击【组装车间】按钮，选择配方【铁矿提炼（低级）】，这个配方需要输入10单位【铁矿】，生成5单位【铁】。\n点击左侧【仓库】列表中的【铁矿】；\n在弹出菜单中，数量填写10，点击确定；\n点击【组装】按钮。\n收集5单位【铁】以继续.",
    "level.guide_01.description.5": "创建合同",
    "level.guide_01.description.6": "执行合同",
