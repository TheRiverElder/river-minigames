const Res = {
    ...
    "level.guide.description.0": "你好，{player_name}！恭喜出任我们星际矿业的CEO，我是您忠诚的秘书，接下来由我教您如何操作。\n按下【确认】按钮以继续。",
    "level.guide.description.1": "首先，在画面上找到并点击星球【Terra】，会在画面右边出现一个信息栏，点击其中的【全面板】按钮。\n找到【初级殖民地】\n按下【确认】按钮以继续。",
    "level.guide.description.2": "等待一会儿，这可能有些慢，一段时间后【内部存储】的进度条会渐渐完成。\n完成后，里面的物资将会被自动添加到星球本地供应网络。\n等待本地供应网达到50单位物资。",
    "level.guide.description.3": "现在要收集一些重要资源谋求利益了。\n等待本地供应网达到10单位物资【铁矿】。",
    "level.guide.description.4": "来到星球信息栏，点击【组装车间】按钮，选择配方【铁矿提炼（低级）】，这个配方需要输入10单位【铁矿】，生成5单位【铁】，点击左侧【仓库】列表中的【铁矿】，在弹出菜单中，数量填写10，点击确定，点击【组装】按钮。\n收集5单位【铁】以继续.",
    "level.guide.description.5": "创建合同",
    "level.guide.description.6": "执行合同",
