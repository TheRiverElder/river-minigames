...
import "./GameUI.scss";
import SpaceMinerUICommonProps, { SpaceMinerClient, SpaceMinerClientDialog, SpaceMinerClientTab, SpaceMinerUIController } from "./SpaceMinerUICommonProps";
...
export default class GameUI extends Component<GameUIProps, GameUIState> {
    ...
    getClient(): SpaceMinerClient {
        const self = this;
        return {
            openTab(tab: SpaceMinerClientTab) { self.props.uiController.openTab(tab); },
            closeTab() { self.props.uiController.closeTab(); },
            openDialog<T>(dialog: SpaceMinerClientDialog<T>) { return self.props.uiController.openDialog(dialog); },
            closeDialog() { self.props.uiController.closeDialog(); },
            getTimeSpeed() { return self.timeSpeed; },
            setTimeSpeed(value: double) { return self.timeSpeed = value; },
        };
    }
    ...
    override render(): ReactNode {
        ...
        const commonProps = { game, i18n, resources, client: this.getClient() };
    ...
    createTab(type: OverlayType): SpaceMinerClientTab {
        const game = this.game;
        const commonProps: SpaceMinerUICommonProps = { game, i18n: this.i18n, resources: this.resources, client: this.getClient() };
